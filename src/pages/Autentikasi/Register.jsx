  ...
  return (
    <div className={`flex ${isMobile ? "flex-col h-screen items-center" : "h-screen"}`}>
      ...
      <div className={`bg-gray-100 ${isMobile ? "w-full h-full flex-grow flex flex-col justify-center items-center" : "w-1/2 flex justify-center items-center"}`}>
        ...
        <div className={`px-8 py-5 text-sm border rounded-md border-primary bg-white shadow-lg shadow-primary ${isMobile ? "w-4/5 mx-auto" : "w-3/4"}`}>
          <h1 className="text-3xl font-bold mb-0.5 text-primary">Daftar</h1>
          <hr className="my-3" />
          {isError && <div className="text-red-800 text-medium bg-red-300 text-center my-4 border rounded-md border-red-300 shadow py-1.5 px-3">{error.message}</div>}
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3 space-y-1">
              ...
              <input type="text" id="nama" name="nama" className="w-full text-sm border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autoComplete="off" onChange={handleInput} placeholder="John Doe" />
            </div>
            <div className="mb-3 space-y-1">
            ...
            <div className="mb-3 space-y-1">
              ...
              <div className="relative">
                ...
                />
                <span className="absolute right-3 top-3 cursor-pointer" onClick={togglePasswordVisibilityOne}>
            ...
            <button type="submit" className="bg-primary hover:bg-secondary text-white font-semibold rounded-md py-2 px-4 w-full mb-4">
              Daftar
            </button>
          </form>
